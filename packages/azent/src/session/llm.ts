...
import { llmClient } from "@azent/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@azent/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@azent/llm/route"
import type { LLMClientService } from "@azent/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @azent/llm. It
