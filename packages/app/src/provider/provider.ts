...
import { Hash } from "@azent/core/util/hash"
...
import { optionalOmitUndefined } from "@azent/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@azent/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
