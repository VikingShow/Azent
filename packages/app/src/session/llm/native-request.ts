import type { JsonSchema, LLMRequest, ProviderMetadata } from "@azent/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@azent/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @azent/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
