import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@azent/llm"
...
// Move this extraction into @azent/llm when Copilot is handled by the native runtime.
