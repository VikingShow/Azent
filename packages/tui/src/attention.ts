...
import defaultSoundPath from "@azent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@azent/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@azent/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@azent/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@azent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@azent/ui/audio/yup-01.mp3" with { type: "file" }
