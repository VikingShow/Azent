import type { TuiPluginApi } from "@azent/plugin/tui"
...
export function Tips(props: { api: TuiPluginApi; connected?: boolean }) {
  ...
  const shortcuts: Shortcuts = {
    ...
    statusView: useCommandShortcut("azent.status"),
...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Azent from reading sensitive files",
  "Use {highlight}azent run{/highlight} for non-interactive scripting",
  "Use {highlight}azent --continue{/highlight} to resume the last session",
  "Use {highlight}azent run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}azent serve{/highlight} for headless API access to Azent",
  "Use {highlight}azent run --attach{/highlight} to connect to a running server",
  "Run {highlight}azent upgrade{/highlight} to update to the latest version",
  "Run {highlight}azent auth list{/highlight} to see all configured providers",
  "Run {highlight}azent agent create{/highlight} for guided agent creation",
  "Use {highlight}/azent{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}azent github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/azent fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}azent debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/azent{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Azent Zen for curated, tested models",
