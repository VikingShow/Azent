...
export const TypeId: TypeId = "~@azent/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@azent/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@azent/effect-sqlite-node/NodeSqliteClient")
